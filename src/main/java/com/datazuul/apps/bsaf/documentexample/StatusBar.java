...
/**
 * A StatusBar panel that tracks a TaskMonitor. Although one could certainly create a more elaborate StatusBar class,
...
public class StatusBar extends JPanel implements PropertyChangeListener {
     ...
     *
     * @param app application embedding this status bar
