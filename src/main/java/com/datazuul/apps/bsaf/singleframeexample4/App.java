 ...
 */
package com.datazuul.apps.bsaf.singleframeexample4;
 ...
 * @Action annotation.
 * <p>
 * This example only defines two
 * @Actions explicitly: open and close. The open action allows the user to choose a file and load it into the textPane,
 * and close just replaces the textPane's contents with the value of the "defaultText" resource. The example inherits
 * @Actions named cut/copy/paste/delete and quit from the Application class. All of the actions are exposed in the menus
 * and/or toolbar.
 *
...
public class App extends SingleFrameApplication {
    ...
    /**
     * Load the specified file into the textPane or popup an error dialog if something goes wrong. The file that's
     * loaded can't be saved, so there's no harm in experimenting with the cut/copy/paste/delete editing actions.
     */
    @Action
    public void open() {
