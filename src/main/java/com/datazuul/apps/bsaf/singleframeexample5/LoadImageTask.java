...
/**
 * A Task that loads an image from a URL. Loading and decoding progress is reported via the Task
 * <code>progress</code> property and messages are generated when the Task begins and when it finishes. If errors occur
 * then warnings are logged and the Task's value is null.
 * <p>
...
public class LoadImageTask extends Task<BufferedImage, Void> {
    ...
    private static final Logger LOGGER = Logger.getLogger(LoadImageTask.class.getName());
